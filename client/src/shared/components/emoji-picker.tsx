...
import { customEmojis } from "@shared/constants/custom-emojis.constant";

type EmojiPickerProps = {
  onSelectEmoji: (emoji: string) => void;
};

export const EmojiPicker = ({ onSelectEmoji }: EmojiPickerProps) => {
  return (
    <div className="relative w-full !max-w-8">
      <Picker
        ...
        onEmojiSelect={(emo: any) => onSelectEmoji(emo.native)}
        emojiSize={20}
        showPreview={false}
        showSkinTones={false}
        theme="light"
