      ...
      >
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            {selected.map((option) => {
              const renderedOption = arrayOptions?.find((o) => o.value === option);
              ...
              return (
                <Badge
                  ...
                  data-fixed={renderedOption.fixed}
                  data-disabled={disabled || undefined}
                >
                  {renderedOption.label}
                  <button
                    className={cn("ml-1 rounded-full outline-none ", (disabled || renderedOption.fixed) && "hidden")}
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "flex-1 max-w-[100px] bg-transparent outline-none placeholder:text-muted-foreground",
                {
